...
Version  : 0.4.7
Release  : 24
URL      : https://cran.r-project.org/src/contrib/circlize_0.4.7.tar.gz
Source0  : https://cran.r-project.org/src/contrib/circlize_0.4.7.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1566485861
